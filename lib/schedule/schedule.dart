...
Future<Schedule> fetchSchedule(
  ...
  final response = await dio.getUri(Uri.parse(
      'https://tools-proxy.leonhellqvist.workers.dev/?service=skola24&subService=getLessons&hostName=katrineholm.skola24.se&unitGuid=ZGI0OGY4MjktMmYzNy1mMmU3LTk4NmItYzgyOWViODhmNzhj&groupGuid=$groupGuid&year=2022&week=$week&scheduleDay=$scheduleDay&lines=true&width=$width&height=$height'));
